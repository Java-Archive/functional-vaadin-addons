...
public interface HelperMethodsTrait {
   ...
   *
   * @param vaadinLocator The part following :: of the vaadin locator string
   * @return
   */
   ...
   *
   * @param condition the condition to wait for to become true
   */
   ...
   * Use e.g. as {@link
   * #waitUntil(ExpectedCondition , long)}
   *
   * @param condition the condition to wait for to become true
   */
  default <T> void waitUntil(ExpectedCondition<T> condition,
   ...
   *
   * @param condition the condition to wait for to become false
   */
   ...
   * #waitUntilNot(ExpectedCondition , long)}
   *
   * @param condition the condition to wait for to become false
   */
  default <T> void waitUntilNot(ExpectedCondition<T> condition,
  ...
  /**
   * For tests extending .. returns the element
   * for the Nth log row
   *
   * @param rowNr The log row to retrieve
  ...
  /**
   * For tests extending, returns the text in
   * the Nth log row
   *
   * @param rowNr The log row to retrieve text for
   ...
   * or not.
   *
   * @param debug true to open debug window, false otherwise
   */
   ...
   *
   * @param push true to use /run-push in the test, false otherwise
   */
   ...
   *
   * @param pathWithQueryParameters The path part of the URL, possibly still containing query
   *                                parameters
   ...
   * does not time out.
   *
   * @param timeoutMillis Number of ms to wait
